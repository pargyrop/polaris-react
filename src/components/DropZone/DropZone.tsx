...
export class DropZone extends React.Component<CombinedProps, State> {
  ...
  render() {
    ...
    const dragOverlayDisplayText = width === Size.ExtraLarge &&
      height !== Size.Small && (
    ...
    const dragOverlayCaption = (width === Size.Medium ||
      width === Size.Large) &&
    ...
    const dragErrorOverlayDisplayText = width === Size.ExtraLarge &&
      height !== Size.Small && (
        <DisplayText size="small" element="p">
          {errorOverlayText}
        </DisplayText>
    ...
    const dragErrorOverlayCaption = (width === Size.Medium ||
      width === Size.Large) &&
